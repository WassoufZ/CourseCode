...
$(function() {
 ...
 //$.fn.datepicker.defaults.format = 'dd/mm/yyyy';
   ...
   /* $('.daterange-basic').daterangepicker({
    ...
    ///$('.daterange-single').datepicker({dateFormat: 'dd/mm/yyyy'});
    //var userdate = $.datepicker.formatDate('dd/mm/yyyy', $(".daterange-single").daterangepicker("getDate"))

  /*  // Single picker
    $('.daterange-single').daterangepicker({ 
        singleDatePicker: true,
        locale: {pickadate-selectors
            format: 'YYYY-MM-DD'
        }

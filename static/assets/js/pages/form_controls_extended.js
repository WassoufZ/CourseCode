...
$(function() {
    ...
    /*    var states = 
            [
              'قراءة نص الجزائر ', 'حل تمارين ', 'تعبير كتابي وشفوي', 'كتابة نص'
            ];*/

          /*var states = 
            [
              'كتابة نص', 'كتابة قصيدة', 'حفظ سورة ', 'حفظ نشيد',
              'حل تمارين ', 'حل تمرين ', 'حل وظيفة منزلية ', 'بحث منزلي',
              , 'تعبير كتابي  ', 'تعبير شفوي','قراءة نص الجزائر ', 'حل تمارين ', 'تعبير كتابي وشفوي', 'كتابة نص',
               'Ecriture d\'un text', 'Ecriture d\'une expression écrite', 'Ecriture d\'une expression écrite ', 'Résoudre des exercices'
            ];*/
            ...
            [
              ...
              , 'تعبير كتابي  ', 'تعبير شفوي','قراءة نص الجزائر ', 'حل تمارين ', 'تعبير كتابي وشفوي', 'كتابة نص',
               ...
               'الأعداد من 0 إلى 99',
                ...
                'مقارنة الأطوال ',
                'التنقل على مرصوفة',
                'الأعداد من 0 إلى 999 (1)',
                'الجمع والطرح (2)',
                'التجميع بالعشرات والمئات (1)',
                'الجمع والطرح (3)',
                'نقل شكل على شكل مرصوفة ',
                'أجند معارفي ',
                'الأعداد من 0 إلى 999(2)',
                'تمثيلات بيانية ومخططات',
                'مقارنة سعات ',
                'الجمع بالأحتفاظ',
                'الأعداد من 0 إلى 999(3)',
                'العدد 1000',
                'الإستقامية' ,
                'التجميع بالعشرات والمئات (2)',
                'الطرح دون احتفاظ',
                'أجند معارفي2',
                'قياس الأطوال',
                'علاقات حسابية بين الأعداد (1)',
                'منتصف قطعة مستقيمة ',
                'مشكلات جمعية وطرحية ',
                'مقارنة كتل',
                'الزاوية القائمة ',
                'قياس كتل ',
                'الأعداد من 0 إلى 9999 (1)',
                'مستقيمات متوازية ومستقيمات متعامدة',
                'الأعداد من 0 إلى 9999 (2)',
                'أجند معارفي3',
                'الأعداد من 0 إلى 9999 (3)',
                'متتالية الأعداد إلى9999',
                'محور تناظر شكل ',
                'وحدات قياس الطول ',
                'علاقات حسابية بين الأعداد (2)',
                'الجمع والطرح ',
                'الطرح بالإضافة',
                'الإنشاء بالتناظر' ,
                'أجند معارفي4',
                ...
                'المجسمات',
                'الضرب وخاصية التوزيع ',
                'مشكلات جمعية وضربية', 
                'قياس سعات ',
                'العدد 10 000 ',
                'المكعب ومتوازي المستطيلات (1)',
                'المكعب ومتوازي المستطيلات (2)',
                'الأعداد إلى 99999 (1)',
                'الأعداد إلى 99999 (2)',
                'قياس مدد (1)',
                'علاقات حسابية بين الأعداد (3)',
                'الأشكال المستوية والمضلعات ',
                'الضرب في مضاعفات 10,100',
                'الحاسبة (1)',
                'حل مشكلات (1)',
                'الأشكال المألوفة (1)',
                'الأشكال المألوفة (2)',
                ...
                'الريف وخدمة الأرض',
                'المدينة والحرف',
                'الإعلام ووسائل النقل ',
                'الألعاب',
                'الآفات الاجتماعية ',
                'الإعلام والمجتمع ',
                'التضامن الإنساني ',
                'شعوب العالم ',
                'العلم والتقدم التكنولوجي ',
                'التلوث البيئي ',
                'الصناعات التقليدية ',
                'الهجرة الداخلية والخارجية ',

                'الأعداد النسيبة ',
                'العمليات على الكسور والأعداد الناطقة', 
                'القوى ذات أسس نسبية صحيحة ',
                'الحساب الحرفي ',
                'المساويات -المتباينات -المعادلات ',
                'التناسبية ',
                'تنظيم معطيات ',
                'البرهان في الرياضيات ',
                'المثلثاث ',
                'المثلث  القائم والدائرة ',
                'خاصية قيتاغورس ,جيب تمام زاوية' ,
                'الانسحاب ',
